...
public class GlideCircleTransform extends BitmapTransformation {
    ...
    protected Bitmap transform(BitmapPool pool, Bitmap toTransform, int outWidth, int outHeight) {
        return transformToCircle(pool, toTransform, outWidth, outHeight);
    }

    private Bitmap transformToCircle(BitmapPool pool, Bitmap toTransform, int outWidth, int outHeight) {
        ...
        Bitmap result = circleCrop(pool, bitmap);
