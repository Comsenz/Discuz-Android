...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	protected void onRefreshing(final boolean doScroll) {
		...
		if (current==PullToRefreshBase.Mode.MANUAL_REFRESH_ONLY||current== PullToRefreshBase.Mode.PULL_FROM_END){
		...
		/*switch (getCurrentMode()) {
			case PullToRefreshBase.Mode.MANUAL_REFRESH_ONLY:
	...
	protected void handleStyledAttributes(TypedArray a) {
		...
		if (mListViewExtrasEnabled) {
			...
			mHeaderLoadingView = createLoadingLayout(getContext(),AnimationStyle.FLIP, PullToRefreshBase.Mode.PULL_FROM_START, a);
			mHeaderLoadingView.setVisibility(View.GONE);
			frame.addView(mHeaderLoadingView, lp);
			mRefreshableView.addHeaderView(frame, null, false);

			mLvFooterLoadingFrame = new FrameLayout(getContext());
			mFooterLoadingView = createLoadingLayout(getContext(),AnimationStyle.ROTATE, PullToRefreshBase.Mode.PULL_FROM_END, a);
