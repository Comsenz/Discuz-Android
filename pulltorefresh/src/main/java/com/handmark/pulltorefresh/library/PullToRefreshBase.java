...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    protected LoadingLayout createLoadingLayout(Context context, AnimationStyle style, Mode mode, TypedArray attrs) {
        LoadingLayout layout = style.createLoadingLayout(context, mode,
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mHeaderLayout = createLoadingLayout(context,AnimationStyle.FLIP, Mode.PULL_FROM_START, a);
        mFooterLayout = createLoadingLayout(context,AnimationStyle.ROTATE, Mode.PULL_FROM_END, a);
